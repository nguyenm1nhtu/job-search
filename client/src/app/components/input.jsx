        ...
        <div>
            <div className="relative">
                <input
                    ...
                    className={clsx(
                        'border placeholder-gray-400 block p-5',
                        inputVariants[variant],
                        error
                            ? 'border border-[color:var(--invalid-color)] border-solid bg-[var(--invalid-bg-color)]'
                            : 'border',
                        className,
                    )}
                    {...rest}
                ...
                {/*Ẩn hiện mật khẩu (Tùy chọn)*/}
                {hide && (
                    <button
                        type="button"
                        onClick={passwordVisibility}
                        className="flex items-center absolute translate-y-[-50%] right-[1.2rem] p-4 top-1/2 cursor-pointer"
                    >
                        {showPassword ? (
                            <svg fill="none" viewBox="0 0 20 12" className="h-[2rem] w-[2rem]">
                                <path
                                    stroke="none"
                                    fill="#000"
                                    fillOpacity=".54"
                            ...
                            <svg fill="none" viewBox="0 0 20 10" className="h-[2rem] w-[2rem]">
                                <path
                                    stroke="none"
                                    fill="#000"
                                    fillOpacity=".54"
            ...
            <div className={clsx('text-[var(--invalid-color)] font-semibold block', errorClassName)}>
