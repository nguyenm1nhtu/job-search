...
export default function Body({ title, jobs, className }) {
    ...
    return (
        <>
            <div className={`w-full py-[24px] flex flex-col gap-10 px-[120px] h-[650px] justify-between ${className}`}>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                        {currentCards.map((job) => (
                            <Link href={`/jobs/${job.job_id}`} key={job.job_id}>
                                <div className="relative cursor-pointer flex flex-col rounded-[8px] bg-white border border-[#E7E7E8] hover:border-[var(--primary-color)]">
                                    <div className="flex flex-col p-4 gap-2">
                                        <h2 className="text-[14px] font-medium">{job.position}</h2>
                                        <div className="flex gap-4">
                                            <div className="w-[58px]  h-[58px] rounded-[8px] overflow-hidden">
                                                <img
                                                    src={job.logo}
                                            ...
                                            <div className="flex flex-col gap-2">
                                                ...
                                                <div className="flex items-center gap-3">
                                                    <FontAwesomeIcon
                                                        ...
                                                        className="text-[#939295] w-[16px] h-[22px]"
                                                    />
                                                    <span className="text-[12px] font-[500]">{`${job.ward_name}, ${job.province_name}`}</span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <div className="flex gap-2 items-center py-1">
                                                <FontAwesomeIcon
                                                    icon={faClock}
                                                    className="text-[#939295] w-[12px] h-[20px]"
                                                />
                                    ...
                                    <div className="absolute text-[18px] right-[10px] top-[7px]">
